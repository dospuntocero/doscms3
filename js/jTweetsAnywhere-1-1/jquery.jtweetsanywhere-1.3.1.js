...
(function($)
{
	...
	defaultTweetProfileImageDecorator = function(tweet, options)
	{
		...
		var imageUrl = t.user ? t.user.profile_image_url.replace("normal","bigger") : false || t.profile_image_url.replace("normal","bigger");;
	...
	defaultLoginInfoContentDecorator = function(options, T)
	{
		...
		if (T.isConnected())
		{
			...
			var imageUrl = T.currentUser.data('profile_image_url').replace("normal","bigger");
